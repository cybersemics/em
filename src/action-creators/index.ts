...
export const mergeThoughts = reducerToThunk<typeof reducers.mergeThoughts>('mergeThoughts')
...
export const setNativeCaretSelection =
  reducerToThunk<typeof reducers.setNativeCaretSelection>('setNativeCaretSelection')
