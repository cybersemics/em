...
export const isGreater = <T1 extends Index, T2 extends Index, K extends keyof T1 & keyof T2>(a: T1, b: T2, key: K) => lower(a[key]) > lower(b[key])

/** Returns true if the first object's key is smaller than the second object's key. */
export const isSmaller = <T1 extends Index, T2 extends Index, K extends keyof T1 & keyof T2>(a: T1, b: T2, key: K) => lower(a[key]) < lower(b[key])
