...
export const parseHTML = (state: State, thoughtsRanked: Path, html: string, { skipRoot }: ImportHtmlOptions = { skipRoot: false }): ThoughtJSON[] => {
  /***********************************************
   * Constants
   ***********************************************/
...
export const saveJSON = (state: State, thoughtsRanked: Path, thoughtsJSON: ThoughtJSON[], { skipRoot }: ImportHtmlOptions = { skipRoot: false }) => {
