...
/** A comparator that sorts 'testY' after 'testZ' as a special case. Returns 0 unless one value is 'testY' and the other is 'testZ'. */
export const compareTestYAfterTestZ: ComparatorFunction<string> = (a: string, b: string) =>
  a === 'testY' && b === 'testZ' ? 1 : a === 'testZ' && b === 'testY' ? -1 : 0
