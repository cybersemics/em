        ...
        dispatch(
          alert(() => (
            <MoveThoughtAlert
              ...
              // parent is empty when the drop target is a root child, which MoveThoughtAlert cannot render as a
              // destination. Root the path so the alert says "moved to home" instead of quoting an empty value.
