...
import { accessToken as accessTokenCurrent, tsid } from '../../db/index'
import permissionsModel from '../../db/permissionsModel'
...
const ModalDevices = () => {
  const permissions = permissionsModel.usePermissions()
