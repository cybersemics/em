...
interface GestureDiagramCheatsheetProps {
  arrowSize?: number
  color?: string
  flexibleSize?: number
 ...
 */
const GestureDiagramCheatsheet = ({
  arrowSize,
  color,
  flexibleSize,
  height,
...
const GestureDiagramCheatsheetMemo = React.memo(GestureDiagramCheatsheet)
GestureDiagramCheatsheetMemo.displayName = 'GestureDiagramCheatSheet'

export default GestureDiagramCheatsheetMemo
