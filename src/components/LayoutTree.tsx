...
import TreeNodeAnimationProvider from './TreeNodeAnimation'
      ...
      >
        <TransitionGroup>
          {treeThoughtsPositioned.map((thought, index) => (
            <TreeNodeAnimationProvider key={thought.key} y={thought.y}>
              <TreeNode
                {...thought}
                index={index}
