...
const Alert: FC = () => {
  ...
  const buttons = undoOrRedo ? (
    <div className={css({ marginTop: '0.5em' })}>
      ...
      >
        <UndoIcon size={14} fill='black' className={css({ position: 'relative', top: '0.25em', right: '0.25em' })} />
        Undo
      </a>
      <a
      ...
      >
        Redo
        <RedoIcon size={14} fill='black' className={css({ position: 'relative', top: '0.25em', left: '0.25em' })} />
      </a>
    </div>
  ) : null
