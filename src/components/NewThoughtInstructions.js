...
export const NewThoughtInstructions = connect(state => ({ isLoading: state.isLoading, status: state.status, tutorialStep: +getSetting('Tutorial Step')[0] }))(({ children, isLoading: localLoading, status, tutorialStep }) =>
