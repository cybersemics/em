...
const Toolbar = ({ dark = true, fontSize = 12, toolbarOverlay = null, scrollPrioritized = true, showTopControls = true }/* : ReturnType<typeof mapStateToProps> */) => {
  ...
  const renderItem: ListRenderItem<string> = useCallback(({ item: id, index }) => {
    ...
    return <TouchableOpacity style={{ margin: 8 }}>
