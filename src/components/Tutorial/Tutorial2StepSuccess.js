...
const Tutorial2StepSuccess = ({ dispatch }) => <Fragment>
  ...
  <p>That's right; you're on your own now. But you can always replay this tutorial or explore all of the available {isMobile ? 'gestures' : 'keyboard shortcuts'} by clicking the <a onClick={() => dispatch(showModal({ id: 'help' }))}>Help</a> link in the footer.</p>
