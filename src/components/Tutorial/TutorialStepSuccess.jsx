...
const TutorialStepSuccess = () => (
  <Fragment>
    <p>
      ...
      personalized thoughtspace. There's a lot more to <b>em</b> however. Additional commands have been designed to
      facilitate a truly fluid sensemaking experience.
    </p>
