...
const EmailIcon = () => {
  return (
    // The svg's bottom edge rests on the link's baseline, so extending the viewBox below the artwork lifts the icon
    // onto the text baseline without rescaling it, level with the url icon.
    <svg width='1.1em' viewBox='00 20 95 73' className={css({ cursor: 'pointer' })}>
