...
interface AToZIconProps extends IconType {
  /** Stroke thickness applied around the filled glyphs (matches CommandsListIcon's API). */
  strokeWidth?: number
}
  ...
  return (
    ...
    >
      <g clipPath='url(#a-to-z-clip)'>
        <path
          d='M8.5 16.793L11.6465 13.6465L12.3535 14.3535L8 18.707L3.64648 14.3535L4.35352 13.6465L7.5 16.793V5H8.5V16.793Z'
          fill={color}
        />
        <path
