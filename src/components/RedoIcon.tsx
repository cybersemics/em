...
const RedoIcon = ({ dark, fill, size = 18, style }: Icon) =>
  <svg version='1.1' className={'icon'} xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width={size} height={size} fill={fill || (dark ? 'white' : 'black')} style={style} viewBox='0 0 512 512'>
