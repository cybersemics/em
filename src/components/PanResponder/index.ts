 ...
 */
function _updateGestureStateOnMove(gestureState: GestureState, touchHistory: PressEvent['touchHistory']): void {
...
// Export PanResponder as named export for convenience
export { PanResponder }

// Re-export types and components
export type { GestureResponderEvent } from './CoreEventTypes'
// PanResponderInstance, PanResponderConfig, and GestureState are already exported above
