...
export interface CommandLearningProgress {
  /** Successful keyboard or gesture repetitions so far, capped at targetReps. */
  reps: number
 ...
 * stable CommandId. A missing progress record means the command has not been started. Saved on this device so the pin
 * and its progress survive a reload.
 */
