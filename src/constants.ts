...
const INITIAL_DROPEMD_MARGINLEFT = -1
const INTIAL_DROPHOVER_FINGERSHIFT = 2.5
export const DROPEND_MARGINLEFT = -1
export const DROPHOVER_MARGINLEFT = 0.6

export const DROPHOVER_FINGERSHIFT = DROPEND_MARGINLEFT - INITIAL_DROPEMD_MARGINLEFT + INTIAL_DROPHOVER_FINGERSHIFT
