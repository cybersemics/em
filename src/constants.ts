...
/**
 * Ref src/components/Content.tsx:84 (padding: '80px 10px 153px 50px')
 * 60 is the sum of left and right padding of main viewport - <div id='content'...>...</div>.
 **/
export const CONTENT_BOX_PADDING = 60
