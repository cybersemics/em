...
import { asyncFocus, ellipsize, headValue, isEM, isRoot, pathToContext, setSelection, isShortcutExecutable } from '../util'
...
// eslint-disable-next-line jsdoc/require-jsdoc
const Icon = ({ fill = 'black', size = 20, style }: IconType) => <svg version='1.1' className='icon' xmlns='http://www.w3.org/2000/svg' width={size} height={size} fill={fill} style={style} viewBox='0 0 20 16' enableBackground='new 0 0 50 50'>
  <g>
