...
const moveThoughtDownSVG = ({ fill = 'black' }) => <svg version="1.1" className="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 19.481 19.481" enableBackground="new 0 0 19.481 19.481">
    <g>
