...
const indentSVG = ({ fill = 'black', size = 20, id }) => <svg version="1.1" id={id} className="icon" xmlns="http://www.w3.org/2000/svg" width={size} height={size} style={{ fill }} viewBox="0 0 64 64" enableBackground="new 0 0 64 64">
