...
const indentSVG = ({ fill = 'black' }) => <svg version="1.1" className="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" style={{ fill }} viewBox="0 0 64 64" enableBackground="new 0 0 64 64">
