...
export { getGlobalSortPreference } from './getSortPreference'
...
export { default as isSortPreferenceAlphabetical } from './isSortPreferenceAlphabetical'
export { default as isContextSorted } from './isContextSorted'
