...
/** Returns the value of a child attribute of a thought. Use a combination of hasChild and attribute to check if an attribute exists but has no children. O(1). */
