...
/** Calculates the next context in the context view. Returns the Lexeme context rendered at that position; build its Path with replaceHead so the context-view step is preserved. */
