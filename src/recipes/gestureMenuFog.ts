...
const gestureMenuFogRecipe = defineRecipe({
  ...
  variants: {
    depth: {
      0: {},
      1: {
        transform: 'translateX(0.375rem) scale(0.875)',
        marginBottom: '-0.275rem',
        opacity: 0.875,
        filter: 'blur(0.5px)',
      },
      2: {
        transform: 'translateX(0.7rem) scale(0.85)',
        marginBottom: '-0.33rem',
        opacity: 0.8,
        filter: 'blur(1.25px)',
      },
      3: {
        transform: 'translateX(1.65rem) scale(0.825)',
        marginBottom: '-0.385rem',
        opacity: 0.7,
        filter: 'blur(1.75px)',
      },
      4: {
        transform: 'translateX(3.25rem) scale(0.75)',
