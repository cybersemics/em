...
export const heading2 = headingCommand(2)
export const heading3 = headingCommand(3)
export const heading4 = headingCommand(4)
export const heading5 = headingCommand(5)
