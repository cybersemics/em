...
export const updateContext = async (id: string, { value, children, lastUpdated, parentId, archived, rank }: Parent) => {
  return db.contextIndex.put({ id, value, children, lastUpdated, parentId, archived, rank })
}
