    ...
    [
      'browserstack',
      {
        ...
        opts: {
          ...
          // Trust the self-signed certificate generated by @vitejs/plugin-basic-ssl
          // so Safari on BrowserStack can access the local HTTPS dev server.
          useCaCertificate: path.resolve(process.cwd(), 'node_modules/.vite/basic-ssl/_cert.pem'),
        },
      },
    ],
  ],
