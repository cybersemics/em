...
export const bulkUpdateThoughtIndex = async thoughts => db.thoughtIndex.bulkPut(thoughts)
...
export const bulkUpdateContextIndex = async contexts => db.contextIndex.bulkPut(contexts)
