...
export const thoughtIndexOperations = {
  ...
  updateRecentlyEdited: recentlyEdited => db.helpers.put({ recentlyEdited }, 'EM'),
  updateSchemaVersion: schemaVersion => db.helpers.put({ schemaVersion }, 'EM'),
  updateLastUpdated: lastUpdated => db.helpers.put({ lastUpdated }, 'EM')
}
