...
| [`layout-rendering.md`](../../docs/layout-rendering.md) | `src/components/LayoutTree.tsx`, `src/hooks/usePositionedThoughts.ts`, visible-thought scroll clamping | Thought positioning, virtualization, or visible-thought scroll bound changes |
