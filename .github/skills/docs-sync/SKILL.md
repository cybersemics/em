...
| [`persistence.md`](../../docs/persistence.md) | `src/data-providers/**`, `src/redux-enhancers/undoRedoEnhancer.ts`, `src/actions/replaceThoughts.ts` | Storage, sync, replication, or document commit/publication changes |
