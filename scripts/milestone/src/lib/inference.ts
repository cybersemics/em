// Inference tuning constants, overridable via MILESTONE_* env vars for experimentation.
const MODEL = process.env.MILESTONE_MODEL ?? 'gpt-5.6-terra'
...
const VOTES = process.env.MILESTONE_VOTES != null ? Number(process.env.MILESTONE_VOTES) : 5
...
// MILESTONE_TEMPERATURE to override for models that support it.
const TEMPERATURE = process.env.MILESTONE_TEMPERATURE != null ? Number(process.env.MILESTONE_TEMPERATURE) : undefined
...
const REASONING_EFFORT = process.env.MILESTONE_REASONING_EFFORT
