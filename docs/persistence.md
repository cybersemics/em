...
Text input is displayed immediately. `Editable` applies a 500 ms throttle before ordinary Redux edits; known membership changes bypass it. Unloaded memberships arrive through persistence confirmation, not a per-keystroke storage lookup.
