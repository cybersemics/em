...
- [Layout Rendering](layout-rendering.md) — How thoughts are positioned in the absolute-flat-list layout, including visible-thought scroll clamping, virtualization, and how the cursor is scrolled into view.
