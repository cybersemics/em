...
- [Debug Log](debug-log.md) — The bounded, persistent rolling log that records app events for diagnosing freezes and other catastrophic bugs on devices with no reachable console.
